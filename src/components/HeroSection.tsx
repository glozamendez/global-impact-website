      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center">
          <div className="mb-8 relative">
            <div className="w-40 h-40 mx-auto mb-6 bg-gradient-to-br from-violet-500 via-purple-600 to-indigo-700 rounded-full flex items-center justify-center text-white text-4xl font-bold shadow-2xl relative overflow-hidden group hover:scale-105 transition-all duration-500">
              <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <span className="relative z-10">GL</span>
              <div className="absolute -inset-1 bg-gradient-to-r from-violet-600 to-indigo-600 rounded-full blur opacity-30 group-hover:opacity-50 transition-opacity duration-500"></div>
            </div>
          ...
          <h1 className="text-4xl md:text-7xl font-bold bg-gradient-to-r from-gray-900 via-purple-900 to-violet-900 bg-clip-text text-transparent mb-6 animate-fade-in">
            Guadalupe Loza-Mendez
          </h1>
          
          <p className="text-xl md:text-3xl bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent mb-4 max-w-4xl mx-auto font-semibold animate-fade-in delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in delay-500">
            ...
            <Button 
              ...
              className="border-2 border-violet-600 text-violet-600 hover:bg-violet-50 hover:border-violet-700 px-10 py-4 text-lg font-semibold rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 bg-white/70 backdrop-blur-sm"
            >
              Learn More
            </Button>
          </div>
