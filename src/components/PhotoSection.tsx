...
export const PhotoSection = () => {
  ...
  return <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-emerald-50 via-green-50 to-yellow-50 relative overflow-hidden">
          ...
          <CardContent className="p-8">
            {!selectedImage ? <div className="text-center">
                ...
                <label htmlFor="photo-upload">
                  <Button className="bg-gradient-to-r from-green-600 to-yellow-600 hover:from-green-700 hover:to-yellow-700 text-white px-8 py-4 text-lg font-semibold rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border-0 cursor-pointer" asChild>
                    <span>
                ...
                <div className="relative inline-block mb-6 group">
                  <img src={selectedImage} alt="Your uploaded photo" className="w-64 h-64 object-cover rounded-2xl shadow-2xl group-hover:shadow-3xl transition-all duration-500" />
                ...
                <label htmlFor="photo-upload-new">
                  <Button variant="outline" className="border-2 border-green-600 text-green-600 hover:bg-green-50 hover:border-green-700 px-6 py-3 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 bg-white/70 backdrop-blur-sm cursor-pointer" asChild>
                    
                  </Button>
                </label>
                <input id="photo-upload-new" type="file" accept="image/*" onChange={handleImageUpload} className="hidden" />
              </div>}
          </CardContent>
        </Card>
      </div>
